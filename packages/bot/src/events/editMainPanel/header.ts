		...
		const label = new LabelBuilder()
			...
			.setTextInputComponent(
				new TextInputBuilder()
					...
					.setValue(model.mainPanel.embeds[0].author?.name ?? '')
		...
		const minIconLabel = new LabelBuilder()
			...
			.setTextInputComponent(
				new TextInputBuilder()
					...
					.setValue(model.mainPanel.embeds[0].author?.icon_url ?? '')
		...
		const iconLabel = new LabelBuilder()
			...
			.setTextInputComponent(
				new TextInputBuilder()
					...
					.setValue(model.mainPanel.embeds[0].thumbnail?.url ?? '')
