...
CREATE TABLE "ticket" (
	...
	"first_messages" jsonb DEFAULT '{"content":"[クローズ]ボタンを押してこのスレッドをクローズできます!","embeds":[{"description":"トラブルやBOTの不具合を報告してください!"}],"rows":{"version":1,"components":[[{"customId":"closeProcess:close:","label":"クローズ","emoji":"<:ai_chime:1465642091978690766>","type":"button","style":4}]]}}'::jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
